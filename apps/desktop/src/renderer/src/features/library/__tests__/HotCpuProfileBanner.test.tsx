...
function installFakeApi(result: AnyResult = { ok: true, value: undefined }): {
...
async function renderBanner(result?: AnyResult): Promise<ReturnType<typeof installFakeApi>> {
  const api = installFakeApi(result);
