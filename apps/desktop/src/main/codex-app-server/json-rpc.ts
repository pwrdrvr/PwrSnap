...
//
// This file is intentionally a near-verbatim lift; see
// docs/plans/2026-05-03-001-feat-pwrsnap-feature-buildout-plan.md §"Decision 4".

import { getMainLogger } from "../log";

export type JsonRpcId = string | number;

const jsonRpcLog = getMainLogger("pwrsnap:json-rpc");
