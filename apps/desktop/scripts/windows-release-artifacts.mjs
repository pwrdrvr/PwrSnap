...
//
// This replaced an earlier alias, `PwrSnap-windows-x64-setup.exe` (#463), which
// carried an architecture no other download button mentions and was never
// reachable at releases/latest/download: it shipped from v1.1.0-alpha.6 onward
// while v1.0.3 held the Latest marker, and neither website ever linked it.
